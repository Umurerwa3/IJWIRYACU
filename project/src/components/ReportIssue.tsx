...
import { Send, MapPin, Camera, Phone, MessageSquare, AlertCircle, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-green-50 p-8 rounded-xl border border-green-200">
          ...
          <p className="text-green-700 mb-4">
            Your issue has been logged with reference ID: <strong>IRY-2024-{Math.floor(Math.random() * 1000)}</strong>
          </p>
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-primary-600 text-white px-6 py-4 rounded-lg font-semibold text-lg hover:bg-primary-700 transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
          >
